*首先，谢谢你能陪我一直读到这里，现在，你已经对bevy有了更详细的认知，凭借之前的知识，现在你应该可以自己写出一些简单的游戏了。不过如果你细心，那你可能察觉到我漏掉了关于物理引擎的这一部分，我们在本书中不会详细介绍，因为这不属于bevy的组成部分（或许以后我可能会专门再写一本书研究如何从0写一个物理引擎>-<），读者可以查看别的相关资料，我们这里就不再赘述了。*

*在这里我们正式进入第二部分，即bevy最复杂最核心的反射与ecs系统，我将会花几个章节的篇幅先把反射讲清楚，然后揭开bevy_reflect与bevy_ecs的核心秘密。*

*让我们把话题拉到更宏大历史进程中，来进一步认识我们平时的工作吧！Bevy 的反射与 ECS 极其复杂，是出了名的难懂，这是因为它在试图解决『图灵机的并发安全困境』与『静态语言缺乏运行时灵活度』这两个大难题。*

*而解答这两个难题的钥匙，就是函数式编程与元编程。（以下话题大多数为闲聊话题，非代码部分，如果不想看也可以不看，不过看了之后会帮助你对于编程有一个全新的理解）。*
...
沃尔玛你程序员们用尽一生的逻辑去编写程序，去穷尽这个符号世界的所有可能。而当我们终于合上电脑、抬起头，望向窗外真实、充满不确定性的复杂世界时，才会发现超越编程之外的，是那些代码无法触及的生命色彩，对于这些我们能做的，只有带着最深的敬畏，保持沉默。
